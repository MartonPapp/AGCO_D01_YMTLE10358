*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YMTLV_EMAIL_REC
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YMTLV_EMAIL_REC     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YMTLV_EMAIL_REC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YMTLV_EMAIL_REC_EXTRACT
TOTAL = YMTLV_EMAIL_REC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YMTLV_EMAIL_REC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YMTLV_EMAIL_REC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YMTLV_EMAIL_REC_EXTRACT
TOTAL = YMTLV_EMAIL_REC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YMTLV_EMAIL_REC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YMTLV_EMAIL_REC'
...
TOTAL = YMTLV_EMAIL_REC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YMTLV_EMAIL_REC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YMTLV_EMAIL_REC-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YMTLV_EMAIL_REC'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YMTLV_EMAIL_REC-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YMTLV_EMAIL_REC_EXTRACT
TOTAL = YMTLV_EMAIL_REC_TOTAL
