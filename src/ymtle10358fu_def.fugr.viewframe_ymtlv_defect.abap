*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YMTLV_DEFECT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YMTLV_DEFECT        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YMTLV_DEFECT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YMTLV_DEFECT_EXTRACT
TOTAL = YMTLV_DEFECT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YMTLV_DEFECT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YMTLV_DEFECT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YMTLV_DEFECT_EXTRACT
TOTAL = YMTLV_DEFECT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YMTLV_DEFECT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YMTLV_DEFECT'
...
TOTAL = YMTLV_DEFECT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YMTLV_DEFECT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YMTLV_DEFECT-UPD_FLAG NE SPACE.
