*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YMTLV_EMAIL_LST
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YMTLV_EMAIL_LST     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YMTLV_EMAIL_LST'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YMTLV_EMAIL_LST_EXTRACT
TOTAL = YMTLV_EMAIL_LST_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YMTLV_EMAIL_LST'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YMTLV_EMAIL_LST-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YMTLV_EMAIL_LST_EXTRACT
TOTAL = YMTLV_EMAIL_LST_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YMTLV_EMAIL_LST-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YMTLV_EMAIL_LST'
...
TOTAL = YMTLV_EMAIL_LST_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YMTLV_EMAIL_LST-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YMTLV_EMAIL_LST-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YMTLV_EMAIL_LST'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YMTLV_EMAIL_LST-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YMTLV_EMAIL_LST_EXTRACT
TOTAL = YMTLV_EMAIL_LST_TOTAL
